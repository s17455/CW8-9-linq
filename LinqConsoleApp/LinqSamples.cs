    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Przyklad1()
        {
            ...
            Console.WriteLine("1.1. \n" + String.Join(", ", res.Select(x => x.ToString())));
                //2. Lambda and Extension methods
                        //2. Lambda and Extension methods
            var res2 = Emps
                .Where(emp => emp.Job == "Backend programmer").Select(emp => emp);

            Console.WriteLine("1.2. \n" + String.Join(", ", res2.Select(x => x.ToString())));
        }
        ...
        {
            Console.WriteLine("8. \n" + Emps.Any(emp => emp.Job == "Backend programmer"));
        }
